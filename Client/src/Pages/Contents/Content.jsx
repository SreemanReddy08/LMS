...
const Content = () => {
  ...
  const handleSubmit = () => {
    ...
    if (size == "" || fileType == "" || fileUrl == "") {
      return alert("Please choose a correct file type");
    }
    let finalThumbnail = thumbnailUrl || "https://cdn-icons-png.flaticon.com/512/2950/2950720.png";
    let obj = { ...formData, size, fileType, thumbnailUrl: finalThumbnail, fileUrl };
    setLoading(true);
    ...
    WidgetRef.current = UploadRef.current.createUploadWidget(
  {
    ...
    resource_type: "auto",
    maxFiles: 1,
    clientAllowedFormats: ["jpg", "jpeg", "png", "mp4", "pdf", "doc", "docx", "ppt", "pptx", "xls", "xlsx", "csv"],
