...
const Home = () => {
  ...
  if (user?.userType === "Tutor") {
    overviewData = overviewData.filter(
      (item) => item.title !== "Admins" && item.title !== "Tutors"
    );
  } else if (user?.userType === "Student") {
    overviewData = overviewData.filter(
      (item) => item.title !== "Admins" && item.title !== "Tutors" && item.title !== "Student"
    );
  }
      ...
      <Navbar>
        <div className="main">
          ...
          <div className="homeFooter">
            Copyright 2026 © Speshway Solutions pvt ltd
          </div>
        </div>
      </Navbar>
    </div>
